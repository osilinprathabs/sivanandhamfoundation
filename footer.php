        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-5 col-md-6">
                    <h1 class="fw-bold text-primary mb-4">Shivanantham<span class="text-whitefoundation">Foundation</span></h1>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>123 Street, Yercadu, India</p>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <a class="btn btn-link" href="volunteer.php">Volunteer</a> 
                    <a class="btn btn-link" href="testimonials.php">Testimonials</a> 
                    <a class="btn btn-link" href="donate.php">Donate</a>  
                    <a class="btn btn-link" href="team.php">Team</a> 
                    <a class="btn btn-link" href="contact.php">Contact Us</a>
                </div>

                <div class="col-lg-2 col-md-6">
                    <h5 class="text-light mb-4">Policy Links</h5>
            
                    <a class="btn btn-link" href="terms.php">Terms & Condition</a>
                    <a class="btn btn-link" href="shipping_return_refund.php">Shipping, Return</a>
                    <a class="btn btn-link" href="privacy_policy.php">Privacy Policy</a>
                    <a class="btn btn-link" href="cancellation_refund.php">Cancellation & Refund Policy</a>
                    <a class="btn btn-link" href="contact.php">Contact Us</a>
                </div>
