...
<head>
    <meta charset="utf-8">
    <title>Shivanantham Foundation</title>
...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar text-white-50 row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div class="col-lg-6 px-5 text-end">
                <?php if (isset($_SESSION['admin_id'])): ?>
                    <small><a class="text-white-50 me-3" href="admin/dashboard.php" title="Admin Dashboard"><i class="fas fa-user-shield me-2"></i>Admin Dashboard</a></small>
                <?php else: ?>
                    <small><a class="text-white-50 me-3" href="#" data-bs-toggle="modal" data-bs-target="#adminLoginModal" title="Admin Login"><i class="fas fa-user-shield me-2"></i>Admin</a></small>
                <?php endif; ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
          <a href="index.php" class="navbar-brand ms-8 ms-lg-0">
    <img src="img/logo.jpg" alt="Shivananthajjm Foundation Logo" style="height: 60px;">
</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="donation.php" class="dropdown-item">Donate</a>
                ...
                <div class="d-none d-lg-flex ms-2">
                    <a class="btn btn-outline-primary py-2 px-3" href="donation.php">
                        Donate Now
