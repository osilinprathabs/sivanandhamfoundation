...
<div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center">
        <h1 class="display-4 text-white animated slideInDown mb-4">Terms and Conditions</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                <li class="breadcrumb-item text-primary active" aria-current="page">Terms and Conditions</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class="card shadow border-0">
                <div class="card-body p-4">
                    ...
                    <ul>
                        ...
                        <li>Donors must provide accurate information for processing payments.</li>
                        <li>We reserve the right to refuse or refund any donation at our discretion.</li>
                    </ul>
                    <h4>3. User Responsibilities</h4>
                    <ul>
                        <li>Users must not use the website for unlawful purposes.</li>
